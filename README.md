# 🛒 Awesome Google-Scholar Scrapers [![ScrapeOps Badge](https://img.shields.io/badge/powered_by-ScrapeOps-blue)](https://scrapeops.io)

> A curated collection of the best open-source scrapers for Google-Scholar — across Python, Node.js, Puppeteer, Playwright, Selenium, and more.  
> Updated regularly • Filterable by language, stars, last updated, and maintenance status.

---

## 🔍 What's Inside
This repo helps you find the **most reliable, actively maintained scrapers** for Google-Scholar, so you don't have to build from scratch.  
...
## 📑 Quick Index
- [Featured Scrapers](#featured-google-scholar-scrapers)
- [Scrapers By Language](#google-scholar-scrapers-by-language)
- [Need Rotating Proxies or CAPTCHA Solving for Google-Scholar](#rotating-proxies-or-captcha-solving-for-google-scholar)
- [Google-Scholar Tutorials & How-Tos](#google-scholar-tutorials)
- [Contributing](#contributing)
- [Compare Proxy Providers](#compare-proxies)

---

## 📦 Featured Scrapers <a id="featured-google-scholar-scrapers"></a>
...
## 🧑‍💻 Google-Scholar Scrapers By Language <a id="google-scholar-scrapers-by-language"></a>
### Python
...
## 🔐 Need Rotating Proxies or CAPTCHA Solving for Google-Scholar?<a id="rotating-proxies-or-captcha-solving-for-google-scholar"></a>

> Google-Scholar uses aggressive anti-bot tech (CAPTCHAs, IP bans, JS challenges).  
> If your Google-Scholar scraper fails, it's not the code — it's the infrastructure.

✅ [ScrapeOps Proxy Aggregator](https://scrapeops.io/proxy-aggregator/) helps:  
- Route requests through 20 + proxy providers  
- Automatically rotate and retry failed requests  
- Reduce ban rate and increase success on Google-Scholar

🎁 **Get 1000 free credits** to test your Google-Scholar scraper 👉 [Start here](https://scrapeops.io)
...
Know a Google-Scholar scraper we missed? Want us to include your project?
